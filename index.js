...
let cityId=0;
function getcityId(data,cityName) {
...
const selectedCityId = getcityId(cityData,cityName);

let districtNames = [];
let districtId=0;
function getDistrictName(data,cityId) {
    data.forEach(element =>{
        if (element.il_id == cityId) {
           districtNames.push(element.name)
...
const resultdistrict = getDistrictName(districtData,selectedCityId)
console.log(cityName+" Şehirinin İlçeleri")
